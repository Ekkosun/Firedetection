...
QT_MOC_LITERAL(1, 12, 5), // "Begin"
QT_MOC_LITERAL(2, 18, 0), // ""
QT_MOC_LITERAL(3, 19, 12), // "std::string*"
QT_MOC_LITERAL(4, 32, 4), // "int*"
QT_MOC_LITERAL(5, 37, 3) // "End"

    },
    "BeginButton\0Begin\0\0std::string*\0int*\0"
    "End"
};
...
void BeginButton::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        auto *_t = static_cast<BeginButton *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->Begin((*reinterpret_cast< std::string*(*)>(_a[1])),(*reinterpret_cast< std::string*(*)>(_a[2])),(*reinterpret_cast< std::string*(*)>(_a[3])),(*reinterpret_cast< int*(*)>(_a[4])),(*reinterpret_cast< int*(*)>(_a[5]))); break;
        case 1: _t->End(); break;
        default: ;
        }
        ...
        {
            using _t = void (BeginButton::*)(std::string * , std::string * , std::string * , int * , int * );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&BeginButton::Begin)) {
                *result = 0;
                return;
            }
        }
        {
            using _t = void (BeginButton::*)();
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&BeginButton::End)) {
                *result = 1;
                return;
            }
        }
...
// SIGNAL 0
void BeginButton::Begin(std::string * _t1, std::string * _t2, std::string * _t3, int * _t4, int * _t5)
{
